...
def instructions_message():
    ...
    program
    '''
    print('''\nThe game objective is to guess the lucky number using
the minimum number of guesses as possible as it will impact 
your score.\n''')
    print('> Instructions:\n')
    print('- Pick your level between easy, medium and hard level')
    print('- For each level you will have 10 guesses available')
    print('''- Easy gives you a lucky number between 1 and 30
with each guess worth 10 points''')
    print('''- Medium gives you a lucky number between 1 and 60
with each guess worth 20 points''')
    print('''- Hard gives you a lucky number between 1 and 120
with each guess worth 40 points''')
